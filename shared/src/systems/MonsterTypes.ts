...
export const SEED_MONSTERS: Record<string, MonsterDefinition> = {
  goblin: {
    ...
    drops: [
      ...
      { itemId: 'tarnished_ring', chance: 0.10 },
      { itemId: 'cracked_bracers', chance: 0.10 },
      { itemId: 'worn_gloves', chance: 0.10 },
      { itemId: 'gnarled_wand', chance: 0.08 },
      { itemId: 'tin_whistle', chance: 0.08 },
    ],
  },
  wolf: {
    id: 'wolf',
    ...
    drops: [
      ...
      { itemId: 'moth_eaten_cloak', chance: 0.10 },
      { itemId: 'tattered_pauldrons', chance: 0.08 },
      { itemId: 'short_bow', chance: 0.08 },
      { itemId: 'prayer_beads', chance: 0.08 },
    ],
  },
  bandit: {
    id: 'bandit',
    ...
    drops: [
      ...
      { itemId: 'frayed_cord_necklace', chance: 0.10 },
      { itemId: 'splintered_buckler', chance: 0.10 },
      { itemId: 'cracked_idol', chance: 0.08 },
      { itemId: 'iron_battleaxe', chance: 0.05 },
    ],
  },
};
