...
- **Tile types**: Plains, Forest, Mountain (non-trav), Water (non-trav), Town, Dungeon, Void (non-trav), Desert (requires waterskin), Lava Field (requires magma_boots), Beach, Hedge (non-trav), Volcano (non-trav). Icons: Town 🏠, Dungeon 🕳️, Mountain ⛰️, Forest 🌲, Water 🌊, Desert 🏜️, Lava Field 🔥, Beach 🏖️, Hedge 🌿, Volcano 🌋.
