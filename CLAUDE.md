...
│   │   └── DungeonTypes.ts    # Dungeon types, floors, entry requirements, rewards, SEED_DUNGEONS
...
│   │   │   ├── DungeonsTab.ts        # Modal form: floors, grid shape, encounter tables, rewards, entry requirements
...
├── dungeons.json              # Dungeon definitions (loaded by ContentStore, auto-seeded)
