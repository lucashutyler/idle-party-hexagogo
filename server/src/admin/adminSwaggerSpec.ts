  ...
  schemas: {
    ItemDefinition: {
      ...
      properties: {
        ...
        equipSlot: { type: 'string', enum: ['head', 'shoulders', 'chest', 'bracers', 'gloves', 'mainhand', 'offhand', 'foot', 'ring', 'necklace', 'back', 'relic'] },
        twoHanded: { type: 'boolean' },
        classRestriction: { type: 'string', example: 'Knight' },
